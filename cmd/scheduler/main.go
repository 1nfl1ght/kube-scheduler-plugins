...
import (
	...
	"sigs.k8s.io/scheduler-plugins/pkg/timebased"
	"sigs.k8s.io/scheduler-plugins/pkg/cpuload"
...
func main() {
	...
	command := app.NewSchedulerCommand(
		...
		app.WithPlugin(timebased.Name, timebased.New)
		app.WithPlugin(cpuload.Name, cpuload.New)
	)
